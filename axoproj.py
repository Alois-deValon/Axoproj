...
if __name__ == '__main__':
    console_width = os.get_terminal_size().columns
    obs=np.load("coordinates/datacube.npy",mmap_mode = "r")

    dec=np.genfromtxt("coordinates/dec.txt")*140
    ra=np.genfromtxt("coordinates/ra.txt")*140
    vrad=np.genfromtxt("coordinates/vrad.txt")
